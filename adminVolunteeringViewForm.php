...
<body>
    <div class="back">
        <a href="adminVolunteeringApplication.php"><img src="https://cdn-icons-png.flaticon.com/512/93/93634.png" alt="Back to Home Page" height="40px" width="40px"></a>
    </div>
   <div class="container">
        <div>
        ...
        <div class="question">
            <div>
                ...
                <p><b>Could you share and describe any previous experience you have with animal volunteering?</b><br><br>
                    <?php echo $past_experience; ?>
                </p>
            </div><br>
            <div>
                <h2><b>Question 2:</b></h2>
                <p><b>In case of an emergency, please provide the contact number of someone we can reach out to. </b><br><br> 
