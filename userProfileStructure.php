...
<body>
    <div class="cross">
        ...
        ?>
                <a href="mainPage.php"><img src="https://static-00.iconduck.com/assets.00/cross-circle-icon-512x512-crxcbljw.png" alt="Back to Home Page" height="40px" width="40px"></a>
        <?php
            }
        ?>
        ...
        <div>
            <h1>
                <input type="text" name="txtName" value="<?php
                    echo $name;
                ?>" class="name" pattern= "/^[a-zA-Z-' ]*$/" required>
            </h1>
        </div>
        ...
        <div class="info">
            ...
            <div>
                ...
                <div >
                    ...
                    echo $contactnum;
                    ?>" class="input" pattern="\d{3}-\d{3}-\d{4}" required>
            ...
            <div>
                <h4>Address:</h4>
                <div>
                <textarea name="txtAddress" id="" cols="30" rows="10" required><?php echo $address; ?></textarea>
